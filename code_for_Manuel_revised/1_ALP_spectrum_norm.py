...
spectrum = 'bn121225417_LAT-LLE_bkgspectra.bak{1}' # inputing background as a source file
bkg_unqual = 'bn121225417_LAT-LLE_bkgspectra.bak'
response = 'bn121225417_LAT-LLE_weightedrsp.rsp'

splitted = spectrum.split("_")[0] # naming convenience
...
E_MeV= xs.Plot.x(1)
bkg = xs.Plot.y(1)
xerr = np.asarray(xs.Plot.xErr(1))
yerr = np.asarray(xs.Plot.yErr(1))
